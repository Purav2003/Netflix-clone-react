                ...
                return <div>
                    <div className="row col-md-12" key="ID">
                        ...
                        <div className='col-md-7' style={{ 'margin-left': '3vw' }}>
                            <h2 style={{ 'font-weight': '700', 'color': '#E50914' }}>{title}{name}</h2><br></br>
                            <h5 className='text-white' style={{ 'lineHeight': '25px', 'textAlign': 'justify' }}><a style={{ color: '#E50914', 'font-weight': '700' }}>Overview:</a> {overview}</h5><br></br>
                            <h5 className='text-white' style={{ 'lineHeight': '25px', 'textAlign': 'justify' }}><a style={{ color: '#E50914', 'font-weight': '700' }}>Date Of Release:</a> {release_date}{first_air_date}</h5><br></br>
                            <h5 className='text-white' style={{ 'lineHeight': '25px', 'textAlign': 'justify' }}><a style={{ color: '#E50914', 'font-weight': '700' }}>Vote:</a> {vote_average} / 10</h5><br></br>
                            <h5 className='text-white' style={{ 'lineHeight': '25px', 'textAlign': 'justify' }}><a style={{ color: '#E50914', 'font-weight': '700' }}>Popularity:</a> {popularity}</h5><br></br>
