...
const API_URL = 'https://api.themoviedb.org/3/tv/popular?api_key=62ebf6fda469c1af3fe79388b1ce3912&page=2'
...
function RecentlyAddedTv() {
    ...
    return (
        <div className='pop-movie-title' id = "pop-movie-title">
            <h5 className='text-white m-4' style={{ fontFamily: 'Netflix Sans' }}><br />Recently Added Tv</h5>
